...
class ListItemWidget extends StatelessWidget {
 ...
 Widget build(BuildContext context) {
   ...
   return GestureDetector(
     onTap: (){
      //  Navigator.of(context).push(MaterialPageRoute(builder: (context) => HomeScreen(auctionModel: AuctionPageModel(id: id, title: title, sellerEmail: sellerEmail, description: description, imageURL: imageURL, date: date, bidderEmail: bidderEmail, bidPrice: bidPrice)))); // AuctionPageModel will be introduced in next resources, for now leave it
     },
     child: Container(
